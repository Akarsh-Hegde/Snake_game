...
class Game:
    ...
    def display_score(self):
        ...
        self.score = self.mc_snake.length*10 - 30
    ...
    def display_gameover(self, user_name):
        self.render_background()
        ...
        pygame.display.flip()
        #add the player details to table
        self.db.insert_user(user_name, self.score)
